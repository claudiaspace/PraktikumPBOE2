...
public class MManusia {
    public static void main(String[] args) {
        PNS p1 = new PNS("Satriyo", LocalDate.of(2006, 1, 4), "Jl. Seroja", 15000000, "198302032006041002");
        ...
        PNS p2 = new PNS("Panji", LocalDate.of(2010, 1, 4), "", 10000000, "198004212010041002");
